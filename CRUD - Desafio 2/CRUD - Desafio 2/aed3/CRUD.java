...
public class CRUD<T extends Registro> {
  ...
  public CRUD(Constructor<T> c, String nome) throws Exception {
    this.nomePasta = nome;
    this.construtor = c;
    arquivo = new RandomAccessFile(this.nomePasta + "/dados.db", "rw");
    if (arquivo.length() == 0)
      arquivo.writeInt(0);
    indiceDireto = new HashExtensivel<>(ParIdEndereco.class.getConstructor(), 4, this.nomePasta + "/id.diretorio.db",
        this.nomePasta + "/id.cestos.db");
  }
