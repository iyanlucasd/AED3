...
public class ParTituloId implements aed3.RegistroHashExtensivel<ParTituloId> {
  ...
  public ParTituloId(String e, int i) {
    try {
      this.titulo = e;
      this.id = i;
      if (e.length() + 4 > TAMANHO)
        throw new Exception("Número de caracteres do título maior que o permitido. Os dados serão cortados.");
    } catch (Exception ec) {
      ec.printStackTrace();
    }
  }
